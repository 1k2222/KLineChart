...
exports.getXAxisClass = getXAxisClass;
var XAxis_1 = __importDefault(require("../../component/XAxis"));
var normal_1 = __importDefault(require("./normal"));
var xAxises = {
    normal: XAxis_1.default.extend(normal_1.default)
};
function registerXAxis(axis) {
    xAxises[axis.name] = XAxis_1.default.extend(axis);
}
